...
fn faucet_costs() {
    ...
    const EXPECTED_FAUCET_INSTALL_COST: u64 = 141_843_520_894;

    const EXPECTED_FAUCET_SET_VARIABLES_COST: u64 = 70_775_980;

    const EXPECTED_FAUCET_CALL_BY_INSTALLER_COST: u64 = 2_645_047_453;

    const EXPECTED_FAUCET_CALL_BY_USER_COST: u64 = 2_545_669_471;
