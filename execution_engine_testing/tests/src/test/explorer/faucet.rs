...
fn faucet_costs() {
    ...
    const EXPECTED_FAUCET_INSTALL_COST: u64 = 141_835_235_435;

    const EXPECTED_FAUCET_SET_VARIABLES_COST: u64 = 70_639_675;

    const EXPECTED_FAUCET_CALL_BY_INSTALLER_COST: u64 = 2_644_931_333;

    const EXPECTED_FAUCET_CALL_BY_USER_COST: u64 = 2_545_472_446;
